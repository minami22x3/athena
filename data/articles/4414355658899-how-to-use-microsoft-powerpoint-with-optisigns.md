...
7. Either: **Assign** to a screen on the Screens Management page or **push** the asset to your screen.
   - If downloaded as a **PDF** or **PPT,** select the **Duration (seconds)**of the entire document. *(Min. 4/page)*
     ![image](https://support.optisigns.com/hc/article_attachments/32753266813587)
...
2. Go to **Files/Assets**, then **Apps,** and search for the **PowerPoint Online** app.
   ![image](https://lh7-rt.googleusercontent.com/docsz/AD_4nXctyxphw64S7IffhAlKONz2CBtl9SM2hYnvL72AVhnlzbT1d3BSe_gnLGsrsRdWmB5TgjhXdOspMocHyc3dr_n3ExHZkoTWhf5wUz8wZLhk6oTEdNfuLrTx_cu4ShuD9Kfli5XmQCbaOevOCPUN9vJEiR_2?key=noHOHSXZOLEkm57p-PUcng)
...
![image](https://support.optisigns.com/hc/article_attachments/40597826081939)
