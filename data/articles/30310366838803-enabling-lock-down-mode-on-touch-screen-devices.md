...
![image](https://support.optisigns.com/hc/article_attachments/51024070327059)
...
1. Open **Extension Manager** on your Pro Player (Gen 2).
   ![image](https://support.optisigns.com/hc/article_attachments/32401202740499)
2. Go to the **Browse** section.
3. Search for "**gestures**".
   ![image](https://support.optisigns.com/hc/article_attachments/32401202744851)
...
5. Go to the **Installed** section, and ensure that the **"Disable Gestures 2021"** extension is enabled.
   ![image](https://support.optisigns.com/hc/article_attachments/32404664184083)
